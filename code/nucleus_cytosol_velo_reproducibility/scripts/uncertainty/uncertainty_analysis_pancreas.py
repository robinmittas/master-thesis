...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        fig.savefig(path / "velo_embedding_s_sum.png", format="png", dpi=500, transparent=True, bbox_inches="tight")
...
if SAVE_FIGURES:
    ...
    path.mkdir(parents=True, exist_ok=True)
    fig.savefig(
        path / "directional_cosine_sim_variance_initrinsic_ssum.svg",
        format="svg",
        transparent=True,
        bbox_inches="tight",
    )
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        path = FIG_DIR / "uncertainty"
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(path / "velo_embedding.svg", format="svg", transparent=True, bbox_inches="tight")
        fig.savefig(path / "velo_embedding.png", format="png", dpi=500, transparent=True, bbox_inches="tight")
...
if SAVE_FIGURES:
    ...
    path.mkdir(parents=True, exist_ok=True)
    fig.savefig(
        path / "directional_cosine_sim_variance_initrinsic_snuc.svg",
        format="svg",
        transparent=True,
        bbox_inches="tight",
    )
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        path = FIG_DIR / "uncertainty"
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(path / "velo_embedding_s_cyt.svg", format="svg", transparent=True, bbox_inches="tight")
        fig.savefig(path / "velo_embedding_s_cyt.png", format="png", dpi=500, transparent=True, bbox_inches="tight")
...
if SAVE_FIGURES:
    ...
    path.mkdir(parents=True, exist_ok=True)
    fig.savefig(
        path / "directional_cosine_sim_variance_initrinsic_scyt.svg",
        format="svg",
        transparent=True,
        bbox_inches="tight",
    )
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        path = FIG_DIR / "uncertainty"
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(path / "velo_embedding_sc.svg", format="svg", transparent=True, bbox_inches="tight")
        fig.savefig(path / "velo_embedding_sc.png", format="png", dpi=500, transparent=True, bbox_inches="tight")
...
if SAVE_FIGURES:
    ...
    path.mkdir(parents=True, exist_ok=True)
    fig.savefig(
        path / "directional_cosine_sim_variance_initrinsic_sc.svg", format="svg", transparent=True, bbox_inches="tight"
    )
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        path = FIG_DIR / "uncertainty"
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(path / "velo_embedding_sn.svg", format="svg", transparent=True, bbox_inches="tight")
        fig.savefig(path / "velo_embedding_sn.png", format="png", dpi=500, transparent=True, bbox_inches="tight")
...
if SAVE_FIGURES:
    ...
    path.mkdir(parents=True, exist_ok=True)
    fig.savefig(
        path / "directional_cosine_sim_variance_initrinsic_sn.svg", format="svg", transparent=True, bbox_inches="tight"
    )

# %%
for i in range(4, 25):
    del adata_sn.obs[f"velocities_velovi_{i}_self_transition"]
    del adata_sc.obs[f"velocities_velovi_{i}_self_transition"]
    # del adata_sn.uns[f"velocities_velovi_{i}_graph_neg"]
    # del adata_sn.uns[f"velocities_velovi_{i}_params"]

# %%
adata_sn.write("/vol/storage/robin/code/trained_adata_sn_uncertainties.h5ad")
adata_sc.write("/vol/storage/robin/code/trained_adata_sc_uncertainties.h5ad")

# %%
adata.write("/vol/storage/robin/code/trained_adata.h5ad")

# %%
adata = sc.read("/vol/storage/robin/code/trained_adata.h5ad")
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(
            path / "directional_cosine_sim_variance_extrinsic_ssum.svg",
            format="svg",
            transparent=True,
            bbox_inches="tight",
        )
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(
            path / "directional_cosine_sim_variance_extrinsic_scyt.svg",
            format="svg",
            transparent=True,
            bbox_inches="tight",
        )
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(
            path / "directional_cosine_sim_variance_extrinsic_snuc.svg",
            format="svg",
            transparent=True,
            bbox_inches="tight",
        )
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(
            path / "directional_cosine_sim_variance_extrinsic_sc.svg",
            format="svg",
            transparent=True,
            bbox_inches="tight",
        )
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(
            path / "directional_cosine_sim_variance_extrinsic_sn.svg",
            format="svg",
            transparent=True,
            bbox_inches="tight",
        )
...
# %%
adata = sc.read("/vol/storage/robin/code/trained_adata.h5ad")
adata_sc = sc.read("/vol/storage/robin/code/trained_adata_sc_uncertainties.h5ad")
adata_sn = sc.read("/vol/storage/robin/code/trained_adata_sn_uncertainties.h5ad")
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        if not os.path.exists(path):
            path.mkdir()
        fig.savefig(path / "intrinsic_uncertainty_compare.svg", format="svg", transparent=True, bbox_inches="tight")
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        if not os.path.exists(path):
            path.mkdir()
        fig.savefig(path / "extrinsic_uncertainty_compare.svg", format="svg", transparent=True, bbox_inches="tight")
...
g.fit(cluster_key="celltype", n_states=11)
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(
            path / "pseudtime_umap_velo_stream_sc.png", format="png", dpi=700, transparent=True, bbox_inches="tight"
        )
        fig.savefig(path / "pseudtime_umap_velo_stream_sc.svg", format="svg", transparent=True, bbox_inches="tight")
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        path = FIG_DIR / "uncertainty"
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(path / "pseudotime_fate_prob_celltype_sc.svg", format="svg", transparent=True, bbox_inches="tight")
        fig.savefig(
            path / "pseudotime_fate_prob_celltype_sc.png", format="png", dpi=700, transparent=True, bbox_inches="tight"
        )
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        path = FIG_DIR / "uncertainty"
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(path / "pseudotime_fate_prob_intrinsic_sc.svg", format="svg", transparent=True, bbox_inches="tight")
        fig.savefig(
            path / "pseudotime_fate_prob_intrinsic_sc.png", format="png", dpi=700, transparent=True, bbox_inches="tight"
        )
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        path = FIG_DIR / "uncertainty"
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(path / "pseudotime_fate_prob_extrinsic_sc.svg", format="svg", transparent=True, bbox_inches="tight")
        fig.savefig(
            path / "pseudotime_fate_prob_extrinsic_sc.png", format="png", dpi=700, transparent=True, bbox_inches="tight"
        )
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(
            path / "pseudtime_umap_velo_stream_sc_dpt.png", format="png", dpi=700, transparent=True, bbox_inches="tight"
        )
        fig.savefig(path / "pseudtime_umap_velo_stream_sc_dpt.svg", format="svg", transparent=True, bbox_inches="tight")
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(
            path / "pseudotime_fate_prob_celltype_sc_dpt.svg", format="svg", transparent=True, bbox_inches="tight"
        )
        fig.savefig(
            path / "pseudotime_fate_prob_celltype_sc_dpt.png",
            format="png",
            dpi=700,
            transparent=True,
            bbox_inches="tight",
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        fig.savefig(
            path / "pseudotime_fate_prob_intrinsic_sc_dpt.png",
            format="png",
            dpi=700,
            transparent=True,
            bbox_inches="tight",
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(
            path / "pseudotime_fate_prob_extrinsic_sc_dpt.svg", format="svg", transparent=True, bbox_inches="tight"
        )
        fig.savefig(
            path / "pseudotime_fate_prob_extrinsic_sc_dpt.png",
            format="png",
            dpi=700,
            transparent=True,
            bbox_inches="tight",
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(
            path / "pseudtime_umap_velo_stream_nuccyt.png", format="png", dpi=700, transparent=True, bbox_inches="tight"
        )
        fig.savefig(path / "pseudtime_umap_velo_stream_nuccyt.svg", format="svg", transparent=True, bbox_inches="tight")
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(
            path / "pseudotime_fate_prob_celltype_nuccyt.svg", format="svg", transparent=True, bbox_inches="tight"
        )
        fig.savefig(
            path / "pseudotime_fate_prob_celltype_nuccyt.png",
            format="png",
            dpi=700,
            transparent=True,
            bbox_inches="tight",
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(
            path / "pseudotime_fate_prob_intrinsic_nuccyt.svg", format="svg", transparent=True, bbox_inches="tight"
        )
        fig.savefig(
            path / "pseudotime_fate_prob_intrinsic_nuccyt.png",
            format="png",
            dpi=700,
            transparent=True,
            bbox_inches="tight",
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(
            path / "pseudotime_fate_prob_extrinsic_nuccyt.svg", format="svg", transparent=True, bbox_inches="tight"
        )
        fig.savefig(
            path / "pseudotime_fate_prob_extrinsic_nuccyt.png",
            format="png",
            dpi=700,
            transparent=True,
            bbox_inches="tight",
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        ...
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(path / "velo_confidence_sn_sc_neighbors.svg", format="svg", transparent=True, bbox_inches="tight")
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        path = FIG_DIR / "velo_confidence"
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(path / "velo_confidence_nuc_cyt.svg", format="svg", transparent=True, bbox_inches="tight")
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        path = FIG_DIR / "velo_confidence"
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(path / "velo_confidence_nuc_cyt_ssum.svg", format="svg", transparent=True, bbox_inches="tight")
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        path = FIG_DIR / "velo_confidence"
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(path / "velo_confidence_sn.svg", format="svg", transparent=True, bbox_inches="tight")
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        path = FIG_DIR / "velo_confidence"
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(path / "velo_confidence_sc.svg", format="svg", transparent=True, bbox_inches="tight")
...
with mplscience.style_context():
    ...
    if SAVE_FIGURES:
        path = FIG_DIR / "velo_confidence"
        path.mkdir(parents=True, exist_ok=True)
        fig.savefig(path / "velo_confidence_all_violin.svg", format="svg", transparent=True, bbox_inches="tight")
